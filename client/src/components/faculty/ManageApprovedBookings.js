...
import { fetchApprovedBookings, cancelFacultyBookingRequest, clearError, clearSuccess } from '../../store/slices/facultySlice';
      ...
      <div className="card">
        <div className="card-header">
          ...
          <p style={{ color: '#666', margin: 0 }}>
            View bookings you have approved that are still pending approval from other faculty members
          </p>
        </div>
...
export default ManageApprovedBookings;
